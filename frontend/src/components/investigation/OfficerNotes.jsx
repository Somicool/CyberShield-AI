  ...
  return (
    <div>
      <textarea
        ...
        className="w-full resize-y rounded-lg border border-slate-800 bg-slate-900/80 px-3 py-2 text-sm text-slate-200 focus:border-purple-600 focus:outline-none"
      />
      <div className="mt-1 flex items-center gap-1 text-[12.5px] text-slate-500">
        {saved ? (
          <>

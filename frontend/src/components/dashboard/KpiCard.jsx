...
export default function KpiCard({ icon: Icon, label, value, accent = 'slate', trend }) {
  ...
  return (
    <div className="group bg-slate-900/70 border border-slate-800 rounded-xl p-4 transition duration-200 hover:border-slate-700 hover:bg-slate-900 hover:-translate-y-0.5">
